...
body{font-family:'Segoe UI',Tahoma,sans-serif;background:#f2f2f2;color:#333;}
...
/* Buttons */
.btn-small{padding:6px 12px;border:none;border-radius:5px;cursor:pointer;font-size:.9rem;background:#666;color:#fff;transition:.3s;}
